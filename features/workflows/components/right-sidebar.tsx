    ...
    <div className="flex flex-col gap-3 border-t border-border pt-3">
      ...
      <div className="flex flex-col gap-2">
            ...
            <div key={criterion.id} className="flex flex-col gap-2">
              ...
              {idx === 1 && (
                <div className="flex items-center gap-2 my-1">
                  ...
                  <div className="flex items-center gap-1.5 bg-muted/60 px-2 py-0.5 rounded border border-border">
                    ...
                    >
                      <SelectTrigger className="h-5 text-[10px] font-bold uppercase tracking-wider px-1.5 border-0 bg-transparent shadow-none">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {conditions.length > 1 && (
                    <Button
                      ...
                      className="size-5 text-muted-foreground hover:text-destructive cursor-pointer"
                    >
        ...
        <Button
          ...
          className="h-7 w-full gap-1 border-dashed text-[11px] text-muted-foreground hover:text-foreground cursor-pointer"
        >
